...
flags.DEFINE_integer('n_query_train', default=19, help='number of test example during a training episode')
...
flags.DEFINE_integer('epoches', default=1000000, help='epoches')
...
flags.DEFINE_integer('n_test_episodes', default=1000, help='number of steps while testing')
...
def main(_):
    ...
    omniglot = datasets.Omniglot(root=args.omniglot_path, download=False, rotations=rotations,
    ...
    targets_set_encoder = tf.reshape(targets_set_encoder, [-1, wid, wid, 64])
